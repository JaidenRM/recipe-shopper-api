...
namespace RecipeShopper.IntegrationTests.Features.Recipes
{
    ...
    public class CreateRecipeTests
    {
        ...
        public async Task Should_create_recipe()
        {
            ...
            {
                new CreateRecipe.CreateIngredient("Strawberries", 0.75m, MeasurementUnit.Cup.ToFriendlyString(), new CreateRecipe.CreateProduct(234567, (int)SupermarketType.Woolworths, "Strawberries")),
                ...
                new CreateRecipe.CreateIngredient("Coconut Water", 1, MeasurementUnit.Cup.ToFriendlyString(), new CreateRecipe.CreateProduct(368749, (int)SupermarketType.Woolworths, "H20 Coconut Water")),
            };
